 ...
 *
 *  标称时序:  0码 T0H=0.4μs T0L=0.85μs, 1码 T1H=0.8μs T1L=0.45μs
 *  本驱动:    0码 T0H=0.42μs T0L=0.83μs, 1码 T1H=0.83μs T1L=0.42μs
 *  误差均在 ±150ns 范围内, 兼容绝大多数 WS2812B/SK6812 及其克隆型号
 *---------------------------------------------------------------------------*/
#define WS2812B_PWM_PERIOD       89  //ARR值, 定时器周期 = (ARR+1)/72MHz = 1.25μs
#define WS2812B_BIT_0_CCR       30  //0码高电平时间 = 30/72MHz ≈ 0.417μs
#define WS2812B_BIT_1_CCR       60  //1码高电平时间 = 60/72MHz ≈ 0.833μs
